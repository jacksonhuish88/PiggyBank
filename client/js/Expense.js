...
function closeExpensePopUp(){
    ...
    let new_expense_name = document.getElementById('expensename').value
    new_btn.innerHTML = new_expense_name
    new_btn.id = new_expense_name
    ...
    for (var i = 0; i < inputArray.length; i++) {
        ...
        var expense_name = expense.innerHTML;
        
        // Add a new row to the HTML table
        summarybody.innerHTML += '<tr name="expenserow"><td>' + expense_name + '</td></tr>';
    };
};
